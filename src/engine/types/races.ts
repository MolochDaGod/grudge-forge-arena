...
export const RACES: RaceConfig[] = [
  {
    ...
    abbr: "BRB",
    color: "#c2410c",
    modelUrl: a("/assets/barbarians/models/characters/BRB_Characters_customizable.FBX"),
    textureUrl: a("/assets/barbarians/textures/BRB_StandardUnits_texture.tga"),
    ...HUMAN_SKIN_HSL,
    skinPalette: [
  ...
  },
  {
    ...
    abbr: "DWF",
    color: "#b45309",
    modelUrl: a("/assets/dwarves/models/characters/DWF_Characters_customizable.FBX"),
    textureUrl: a("/assets/dwarves/textures/DWF_Standard_Units.tga"),
    ...HUMAN_SKIN_HSL,
    skinPalette: [
  ...
  },
  {
    ...
    abbr: "ELF",
    color: "#0891b2",
    modelUrl: a("/assets/elves/models/characters/ELF_Characters_customizable.FBX"),
    textureUrl: a("/assets/elves/textures/ELF_HighElves_Texture.tga"),
  ...
  },
  {
    ...
    abbr: "ORC",
    color: "#15803d",
    modelUrl: a("/assets/orcs/models/characters/ORC_Characters_Customizable.FBX"),
    textureUrl: a("/assets/orcs/textures/ORC_StandardUnits.tga"),
  ...
  },
  {
    ...
    abbr: "UD",
    color: "#7c3aed",
    modelUrl: a("/assets/undead/models/characters/UD_Characters_customizable.FBX"),
    textureUrl: a("/assets/undead/textures/UD_Standard_Units.tga"),
  ...
  },
  {
    ...
    abbr: "WK",
    color: "#1d4ed8",
    modelUrl: a("/assets/western-kingdoms/models/characters/WK_Characters_customizable.FBX"),
    textureUrl: a("/assets/western-kingdoms/textures/WK_Standard_Units.tga"),
    ...HUMAN_SKIN_HSL,
    skinPalette: [
